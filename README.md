...
**_Now shipped with some configurable options_** via autogenerated config.json.
...
- Fira Code Nerd Font
- **_For theming with the end-4 scripts:_**
...
You can generally test out matshell via the flake exposed package `nix run github:SrwR16/matshell`. For a NixOS implementation and example [script](https://github.com/SrwR16/matshell/blob/master/nix/hm-module.nix) with matugen, and a [custom cli utility](https://github.com/Neurarian/image-hct) to get chroma/tone, you can enable dedicated options in the home-manager module:
